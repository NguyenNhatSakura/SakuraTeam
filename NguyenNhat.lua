...
local NguyenNhat = Instance.new("ScreenGui")
...
NguyenNhat.Name = "NguyenNhat"
NguyenNhat.Parent = (game:GetService("CoreGui") or gethui())
NguyenNhat.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
_G.NguyenNhatLoaded = true

main.Name = "main"
main.Parent = NguyenNhat
...
execbox.PlaceholderText = "-- Thanks for using NguyenNhat!"
execbox.Text = ""
...
local function QIWXMR_fake_script() -- main.LocalScript 
	...
	print("Welcome, "..game.Players.LocalPlayer.Name.. " to NguyenNhat!.")
	...
	local openNguyenNhat = screengui.open
...
mainframe.Draggable = true
	...
	click(openNguyenNhat, function()
		openNguyenNhat.Visible = false
		mainframe.Visible = true
		openNguyenNhat.Draggable = true
	end)
			...
			if scriptthing:IsA("Frame") and scriptthing.Name:match("scriptexample") then
				...
				repeat
					...
					if next(gamedata) == nil then
						print("NguyenNhat has found no results.")
					else
...
function identifyexecutor()
    return "NguyenNhat Android v2.0.0"
end
