...
loadstring(game:HttpGet("https://raw.githubusercontent.com/NguyenNhatSakura/SakuraTeam/refs/heads/main/ThongTin.lua"))()
	...
	return function(Config)
		...
		TitleBar.CloseButton = BarButton(Components.Assets.Close, UDim2.new(1, -4, 0, 4), TitleBar.Frame, function()
			Library.Window:Dialog({
				Title = "Close  Hub",
				Content = "Are you sure you want to exit Sakura Hub?",
				Buttons = {
					{
						Title = "Yes",
						Callback = function()
	...
	return function(Config)
		...
		Window.Root = New("Frame", {
			...
			New("ImageLabel", {
				...
				BackgroundTransparency = 0.7,
				Image = "rbxassetid://73588662119305",
				ZIndex = 0,
			}, {
				New("UICorner", {
					CornerRadius = UDim.new(0, 10),
...
local Icons = {
    ...
    ["lucide-home-Sakura"] = "rbxassetid://81460299233144",
    ["lucide-kawai-Sakura"] = "rbxassetid://86465146158904"
}
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=86465146158904"
